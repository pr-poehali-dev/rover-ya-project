      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Продвинутый Интеллект, <br className="hidden sm:block" />Человекоподобная Интуиция
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Создан с передовыми технологиями для понимания, обучения и адаптации к вашим уникальным потребностям.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Ровер учится на ваших взаимодействиях, постоянно улучшая свои реакции и действия для лучшего обслуживания ваших потребностей."
            index={0}
          />
          <FeatureCard
            ...
            title="Естественное Взаимодействие"
            description="Общайтесь, используя естественный язык и жесты. Ровер понимает контекст и отвечает соответственно."
            index={1}
          />
          <FeatureCard
            ...
            title="Точные Движения"
            description="Продвинутые моторизованные суставы обеспечивают плавные, человекоподобные движения с исключительным балансом и координацией."
            index={2}
          />
          <FeatureCard
            ...
            description="Продвинутые датчики и технология картографирования позволяют Роверу легко навигировать в сложных средах."
            index={3}
          />
          <FeatureCard
            ...
            description="Встроенные протоколы защищают ваши данные и конфиденциальность, а физические средства защиты обеспечивают безопасную работу."
            index={4}
          />
          <FeatureCard
            ...
            title="Помощь в Задачах"
            description="От простых напоминаний до сложных многоэтапных задач, Ровер может помочь с широким спектром деятельности."
            index={5}
          />
        </div>
      </div>
