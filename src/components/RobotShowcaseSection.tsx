...
const RoverShowcaseSection = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full py-20 bg-gray-100" id="rover-showcase">
        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            <div className="pulse-chip mb-4">
              ...
              <span>Встречайте Будущее</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4">
              Точная Инженерия Встречает <span className="text-[#FC4D0A]">Адаптивный ИИ</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Наш робот-доставщик представляет собой идеальное сочетание передовой механической 
              инженерии и современного искусственного интеллекта, созданного для бесшовной 
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            <img 
              ...
              alt="Автономный робот-доставщик Ровер" 
              className="w-full object-cover"
            />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">Робот-доставщик нового поколения</h3>
                  <p className="text-white/80">Создан для городской доставки</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Продвинутые Сенсоры</h4>
              <p className="text-gray-600">Высокоточные сенсоры обеспечивают восприятие окружающей среды в реальном времени и распознавание объектов.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Адаптивное Обучение</h4>
              <p className="text-gray-600">Непрерывно учится на основе маршрутов для улучшения производительности и оптимизации доставки.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Плавное Движение</h4>
              <p className="text-gray-600">Спроектирован для естественного, эффективного движения с высокой маневренностью на всех типах поверхностей.</p>
            </div>
          </div>
        </div>
      </div>
...
export default RoverShowcaseSection;
