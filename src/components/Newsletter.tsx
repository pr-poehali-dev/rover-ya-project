...
const Newsletter = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!email) {
      toast({
        title: "Пожалуйста, введите ваш email адрес",
        variant: "destructive"
      });
      return;
    }
    ...
    setTimeout(() => {
      toast({
        ...
        description: "Вы скоро получите обновления о Ровере."
      });
      setEmail("");
    ...
    <section id="newsletter" className="bg-white py-0">
      <div className="section-container opacity-0 animate-on-scroll">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="text-5xl font-display font-bold mb-4 text-left">Подпишитесь на рассылку</h2>
          <p className="text-xl text-gray-700 mb-10 text-left">
            Первыми узнавайте о прорывах, партнёрствах и возможностях развёртывания
          </p>
