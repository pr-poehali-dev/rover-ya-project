...
const RoverSection = () => {
  ...
  return <div ref={sectionRef} className="relative" style={{
    height: '300vh'
      ...
      <section className="w-full h-screen py-10 md:py-16 sticky top-0 overflow-hidden bg-white" id="why-rover">
        <div className="container px-6 lg:px-8 mx-auto h-full flex flex-col">
          ...
          <div ref={cardsContainerRef} className="relative flex-1 perspective-1000">
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Ровер решает задачи доставки последней мили
                  </h3>
                </div>
              </div>
            </div>
            ...
            pointerEvents: isSecondCardVisible ? 'auto' : 'none'
              ...
              <div className="absolute top-4 right-4 z-20">
                <div className="inline-flex items-center justify-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm text-white">
                  <span className="text-sm font-medium">Адаптивность</span>
                </div>
              </div>
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Ровер адаптируется к городской среде и погодным условиям
                  </h3>
                </div>
              </div>
            </div>
            ...
            pointerEvents: isThirdCardVisible ? 'auto' : 'none'
              ...
              <div className="relative z-10 p-5 sm:p-6 md:p-8 h-full flex items-center">
                <div className="max-w-lg">
                  <h3 className="text-2xl sm:text-3xl md:text-4xl font-display text-white font-bold leading-tight mb-4">
                    Ровер обеспечивает <span className="text-[#FC4D0A]">безопасную доставку</span> 24/7
                  </h3>
                </div>
              </div>
            </div>
